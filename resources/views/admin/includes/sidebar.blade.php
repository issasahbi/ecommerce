        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item  open ">
                <a href=""><i class="la la-home"></i>
                    ...
                    <span
                        class="badge badge badge-info badge-pill float-right mr-2">{{App\Models\Language::active()->count()}}</span>
                </a>
            ...
            <li class="nav-item"><a href=""><i class="la la-group"></i>
                    ...
                    <span
                        class="badge badge badge-danger badge-pill float-right mr-2">{{App\Models\MainCategory::where('translation_lang',get_default_lang())->active()->count()}}</span>
                </a>
                <ul class="menu-content">
