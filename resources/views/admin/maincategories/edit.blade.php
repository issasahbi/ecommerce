                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                      ...
                                      {{--  <ul class="nav nav-tabs">
                                        ...
                                        <ul class="nav-top-border nav nav-tabs nav-justified">
                                            @isset($mainCategory->categories)
                                                @foreach($mainCategory->categories as $index=>$translation)
                                                <li class="nav-item">
                                                    <a class="nav-link  @if($index==0) active @endif " id="active-tab" data-toggle="tab" href="#active{{$index}}" aria-controls="active"
                                                       aria-expanded="true">{{$translation->translation_lang}}</a>
                                                </li>
                                                @endforeach
                                            @endisset
                                        </ul>
                                        <div class="tab-content px-1 pt-1">
                                            @isset($mainCategory->categories)
                                                @foreach($mainCategory->categories as $index=>$translation)
                                                    <div role="tabpanel" class="tab-pane @if($index==0) active @endif " id="active{{$index}}" aria-labelledby="active-tab"
                                                 aria-expanded="true">
                                                <form class="form"
                                                      action="{{route('admin.maincategories.update',$translation -> id)}}"
                                                      method="POST"
